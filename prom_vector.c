/* Realizar un programa en lenguaje c que lea el vector de un maximo de 10 posiciones, sabiendo que
 dichos datos son de tipo entero, luego determine el promedio de todos los valores y el mayor de los
